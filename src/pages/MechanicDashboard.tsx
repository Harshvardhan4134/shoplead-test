...
const MechanicDashboard = () => {
  ...
  // Filter mechanic jobs (simplified filter)
  const mechanicJobs = jobs.filter(job => 
    (job.status === 'In Progress' || job.status === 'New') &&
    (!job.work_center || 
      job.work_center === 'Mechanical' || 
      job.work_center.toLowerCase().includes('mechan') ||
      job.work_center.toLowerCase().includes('assembl'))
  );
  ...
  return (
    <div className="container mx-auto p-6">
      <div className="mb-6">
        <h1 className="text-2xl font-bold mb-1">Mechanic Dashboard</h1>
        <p className="text-gray-600">View and manage mechanical and assembly jobs</p>
      </div>
        ...
        <div className="bg-white p-4 rounded-lg shadow">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold">{mechanicJobs.length}</p>
            </div>
        ...
        <div className="overflow-x-auto">
          ...
          {sortedJobs.length === 0 && (
            <div className="text-center py-8">
              <p className="text-gray-500">No mechanical jobs found matching your search criteria.</p>
            </div>
          )}
        </div>
      </div>
